...
// دالة تصفية الطبقات المرئية للسطور داخل موديول المعاينة التفاعلية
function updatePreviewVisibility() {
    const configs = [
        { id: 'prevGlyphs', selector: '.preview-glyphs' },
        { id: 'prevArabic', selector: '.preview-arabic' },
        { id: 'prevId', selector: '.preview-row:nth-child(1)' },
...
window.onload = () => {
    initSupabase();
    initResize('splitter1', 'metaPanel', true); // تفعيل السحب للوحة اليمنى
    addNewSentence();
};
